...
export const columns: ColumnDef<startupDataPayload>[] = [
  {
    id: "No",
    header: () => <div className="text-right text-white">No</div>,
    cell: (info) => {
  ...
  },
  {
    ...
    header: ({ column }) => {
      return (
        <Button
          className="flex pl-0 hover:bg-transparent gap-1 text-white"
          variant="ghost"
      ...
      return (
        <div className="flex flex-row-reverse">
          <div className="flex flex-row gap-1">
            <Button
              className="flex pr-0 hover:bg-transparent gap-1 text-white"
              variant="ghost"
              onClick={() => column.toggleSorting()}
            >
              Taxes paid
      ...
      return (
        <div
          className={`text-right font-medium ${
            val > 0 ? "text-green-500" : val < 0 ? "text-red-500" : "text-white"
          }`}
        >
          {tax}
        </div>
  ...
  return (
    <div>
      <div className="flex items-center justify-centers gap-2 mb-4 text-5xl">
        <h1 className=" font-medium text-white">Startups</h1>
      ...
      <div className=" gap-3 flex flex-row w-full mt-3 mb-2">
        <div className="relative min-w-[300px] flex items-center mb-3">
          ...
          />
          <SearchIcon className="absolute right-2 top-50%" color="white" />
        </div>
      </div>
      {/* table */}
