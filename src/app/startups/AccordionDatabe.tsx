  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      ...
      <AccordionItem value="item-4">
        ...
        <AccordionContent className="flex flex-col gap-4 text-balance">
          <p>
            Yes. Use the <q>List My Startup</q> form below to request inclusion.
            Also, register and list your startup on the Dealroom (URL:
            https://app.dealroom.co/) database. We will not upload any data
            without Dealroom registration and proper profile.
          </p>
        </AccordionContent>
      </AccordionItem>
